...
<!--CONNECTION DONE-->
  <%
      ...
      int lf  =fare.length();
        ...
        //
        int lt  =total_seats.length();
        int sum2 = 0;
        int b2=1;
        for(int i=lt-1;i>=0;i--)
        {
          int num = total_seats.charAt(i)-'0';
          sum2 = sum2*b2+num;
          b2 = b2*10;
        }
        int t2 = sum2;
      ...
      prep=connection.prepareStatement("insert into bus_name values(?,?,?,?)");
      ...
      %>
       <div id="head">          
      <font size="5" face="arial">SUCCESSFULLY ADDED</font></div><br><br>
      <center><br><br>
      <a href="admin.jsp"><button type="submit" class="btn btn-danger">BACK</button></a></center>
